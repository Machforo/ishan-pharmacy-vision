...
export default function MuseumComputerLabPage() {
  ...
  const fallback = {
    title: "Pharma Museum & Computer Lab",
  ...
  const defaultSections: Record<string, React.ReactNode> = {
    header: (
      <PageHeader
        ...
        breadcrumbs={[{ label: "Labs" }, { label: "Pharma Museum & Computer Lab" }]}
      />
    ),
    overview: (
    ...
    museum_exhibits: (
      <section key="museum_exhibits" className="py-8">
        <div className="container-wide">
  ...
  const defaultOrder = ["header", "overview", "museum_exhibits", "gallery", "cta"];

  return (
    <Layout>
      <DynamicPageSections
        pageId="museum_computer_lab"
